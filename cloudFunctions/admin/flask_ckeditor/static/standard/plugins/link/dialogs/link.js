...
(function () {
    CKEDITOR.dialog.add("link", function (c) {
        ...
        var n = CKEDITOR.plugins.link, q, r = function () {
            var a = this.getDialog(), b = a.getContentElement("target", "popupFeatures"),
                a = a.getContentElement("target", "linkTargetName"), p = this.getValue();
        ...
        }, g = c.lang.common, b = c.lang.link, d;
        return {
            title: b.title,
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    onChange: function () {
                        var a = this.getDialog(), b = ["urlOptions", "anchorOptions", "emailOptions"],
                            p = this.getValue(), f = a.definition.getContents("upload"),
                            f = f && f.hidden;
                    ...
                    type: "vbox", id: "urlOptions", children: [{
                        type: "hbox", widths: ["25%", "75%"], children: [{
                            ...
                            type: "text", id: "url", label: g.url, required: !0, onLoad: function () {
                    ...
                    type: "vbox", id: "anchorOptions", width: 260, align: "center", padding: 0, children: [{
                        ...
                        label: b.selectAnchor, setup: function () {
                ...
                id: "target", requiredContent: "a[target]", label: b.target, title: b.target, elements: [{
                    type: "hbox", widths: ["50%", "50%"], children: [{
                        ...
                        "default": "notSet",
                        style: "width : 100%;",
                        items: [[g.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"], [g.targetNew,
                            "_blank"], [g.targetTop, "_top"], [g.targetSelf, "_self"], [g.targetParent, "_parent"]],
                        onChange: r,
                        setup: function (a) {
                ...
                elements: [{type: "file", id: "upload", label: g.upload, style: "height:40px", size: 29}, {
                    type: "fileButton",
                    id: "uploadButton",
                ...
                id: "advanced", label: b.advanced, title: b.advanced, elements: [{
                    type: "vbox", padding: 1, children: [{
                        ...
                        children: [{
                            ...
                            "default": "",
                            style: "width:110px",
                            items: [[g.notSet, ""], [b.langDirLTR, "ltr"], [b.langDirRTL, "rtl"]],
                            setup: e,
                            commit: m
                        }, {
                            type: "text",
