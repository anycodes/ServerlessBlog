...
(function () {
    ...
    function I(a) {
        ...
        return {
            getCurrentLangGroup: function (c) {
                a:{
                    for (var e in a) for (var d in a[e]) if (d.toUpperCase() === c.toUpperCase()) {
                        c = e;
                        break a
                    }
                    c = ""
    ...
    var f = function () {
        var a = function (a, b, e) {
            ...
            a = a + "\x3d" + b;
            for (var h in e) b = e[h], a += "; " + h, !0 !== b && (a += "\x3d" + b);
            document.cookie = a
        };
        return {
            postMessage: {
                init: function (a) {
                    ...
                    var b = Object.prototype.toString,
                        e = a.fn || null, g = a.id || "", f = a.target || window, h = a.message || {id: g};
                    a.message && "[object Object]" == b.call(a.message) && (a.message.id ? a.message.id : a.message.id = g, h = a.message);
    ...
    var J = function (b) {
        ...
        for (e in b) {
            if (c = a.dialog.getContentElement(a.dialog._.currentTabId,
                e)) c = c.getElement(); else if (b[e].instance) c = b[e].instance.getElement().getFirst() || b[e].instance.getElement(); else continue;
            d = b[e].localizationID || e;
            c.setText(a.LocalizationComing[d])
        }
    }, K = function (b) {
        var c, d, e;
        for (e in b) c = a.dialog.getContentElement(a.dialog._.currentTabId, e), c || (c = b[e].instance), c.setLabel && (d = b[e].localizationID || e, c.setLabel(a.LocalizationComing[d] + ":"))
    }, t, A;
    ...
    a.sendData = function (b) {
        ...
        var f = function (h) {
            c = b._.currentTabId;
            h = h || window.event;
            h.data.getTarget().is("a") && c !== a.previousTab && (a.previousTab = c, d = b._.contents[c].Content, e = a.iframeNumber + "_" + c, a.div_overlay.setEnable(), d.getElement().getChildCount() ? E(a.targetFromFrame[e], a.cmd[c]) : (a.setIframe(d, c), g = document.getElementById(e), a.targetFromFrame[e] = g.contentWindow))
        };
        b.parts.tabs.removeListener("click", f);
        b.parts.tabs.on("click", f)
    };
    a.buildSelectLang = function (a) {
        var c = new CKEDITOR.dom.element("div"), d = new CKEDITOR.dom.element("select");
        a = "wscLang" + a;
    ...
    a.buildOptionLang =
        function (b, c) {
            var d = document.getElementById("wscLang" + c), e = document.createDocumentFragment(), g, f, h = [];
            if (0 === d.options.length) {
                for (g in b) h.push([g, b[g]]);
                h.sort();
                for (var n = 0; n < h.length; n++) g = document.createElement("option"), g.setAttribute("value", h[n][1]), f = document.createTextNode(h[n][0]), g.appendChild(f), e.appendChild(g);
                d.appendChild(e)
            }
    ...
    var B = function (a) {
        var c = document, d = a.target || c.body, e = a.id || "overlayBlock", g = a.opacity || "0.9";
        a = a.background || "#f1f1f1";
        var f = c.getElementById(e), h = f || c.createElement("div");
        h.style.cssText =
            "position: absolute;top:30px;bottom:41px;left:1px;right:1px;z-index: 10020;padding:0;margin:0;background:" + a + ";opacity: " + g + ";filter: alpha(opacity\x3d" + 100 * g + ");display: none;";
        h.id = e;
        f || d.appendChild(h);
        return {
            setDisable: function () {
        ...
        var e = new CKEDITOR.dom.element("div"), g = new CKEDITOR.dom.element("input"),
            f = new CKEDITOR.dom.element("label"), h = "wscGrammerSuggest" + b + "_" + c;
        e.addClass("cke_dialog_ui_input_radio");
        e.setAttribute("role", "presentation");
        e.setStyles({width: "97%", padding: "5px", "white-space": "normal"});
        g.setAttributes({type: "radio", value: c, name: "wscGrammerSuggest", id: h});
        ...
        var d, e = a.iframeNumber + "_" + a.dialog._.currentTabId;
        ...
        b.onchange = function (b) {
            ...
            d = a.cmd[d];
            b && v[b] && v[b].allowedTabCommands[d] || (d = v[b].defaultTabCommand);
            for (var h in a.cmd) if (a.cmd[h] == d) {
                a.previousTab = h;
                break
            }
            f.postMessage.send({
                message: {
                    ...
                    text: a.dataTemp,
                    cmd: d
                }, target: a.targetFromFrame[e], id: "selectionLang_outer__page"
            })
        }
    }, M = function (b) {
        var c, d = function (b) {
        ...
        grammerSuggest: function (b) {
            ...
            b = b.grammSuggest;
            for (var c = b.length, d = !0, e = 0; e < c; e++) a.grammerSuggest.getElement().append(L(b[e], b[e], d)), d = !1;
            p();
            a.div_overlay.setDisable()
            ...
            var c = z(a.selectNode.Categories), d = 0;
            a.selectNode.Categories.clear();
            for (var e in b) b = document.createElement("option"), b.text = e, b.value = e, c.$.add(b, d), d++;
            ...
            }, f.postMessage.send({message: d, target: a.targetFromFrame[void 0]})) : c = "");
        ...
        setTimeout(function () {
                ...
                if (f.misc.hasClass(c, "cke_dialog_tab") || f.misc.hasClass(c, "cke_dialog_contents_body") || !f.misc.isVisible(c)) for (var e = 0, g; e < d.count(); e++) {
        ...
        setTimeout(function () {
            ...
            a.dialog._.editor.focusManager.currentActive.focusNext();
            d = f.misc.findFocusable(a.dialog.parts.contents);
            if (f.misc.hasClass(c, "cke_dialog_tab") || f.misc.hasClass(c, "cke_dialog_contents_body") || !f.misc.isVisible(c)) for (var e =
                0, g; e < d.count(); e++) {
                if (g = d.getItem(e), f.misc.isVisible(g.$)) {
                    try {
                        g.$.focus()
    ...
    CKEDITOR.dialog.add("checkspell", function (b) {
        function c(a) {
            var c = parseInt(b.config.wsc_left, 10), e = parseInt(b.config.wsc_top, 10),
                d = parseInt(b.config.wsc_width, 10), f = parseInt(b.config.wsc_height, 10),
                l = CKEDITOR.document.getWindow().getViewPaneSize();
            a.getPosition();
            var m = a.getSize(), r = 0;
            if (!a._.resized) {
                var r = m.height - a.parts.contents.getSize("height", !(CKEDITOR.env.gecko ||
            ...
            a._.moved || (r = isNaN(c) && isNaN(e) ? 0 : 1, isNaN(c) && (c = (l.width - m.width) / 2), 0 > c && (c = 0), c > l.width -
            m.width && (c = l.width - m.width), isNaN(e) && (e = (l.height - m.height) / 2), 0 > e && (e = 0), e > l.height - m.height && (e = l.height - m.height), a.move(c, e, r))
        }
        ...
        function d() {
            ...
            (function (a) {
                var b = {
                    ...
                    expiration: 31622400, get: function (a) {
                        ...
                        b = encodeURIComponent(b);
                        a = a + "\x3d" + b;
                        for (var f in c) b = c[f], a += "; " + f, !0 !== b && (a +=
                            "\x3d" + b);
                        document.cookie = a
            ...
            b.wsc.addWords = function (a, c) {
                var d = b.config.wsc.DefaultParams.serviceHost + b.config.wsc.DefaultParams.ssrvHost + "?cmd\x3ddictionary\x26format\x3djson\x26customerid\x3d1%3AncttD3-fIoSf2-huzwE4-Y5muI2-mD0Tt-kG9Wz-UEDFC-tYu243-1Uq474-d9Z2l3\x26action\x3daddword\x26word\x3d" +
                    a + "\x26callback\x3dtoString\x26synchronization\x3dtrue", e = document.createElement("script");
        ...
        var e = function (c) {
            ...
            var d = a.iframeNumber + "_" +
                c, e = a.textNode[c].getValue(), g = this.getElement().getAttribute("title-cmd");
            f.postMessage.send({
            ...
            "FinishChecking" == g && b.config.wsc_onFinish.call(CKEDITOR.document.getWindow().getFrame())
        }, g = {minWidth: 560, minHeight: 444}, k = !1;
        return {
            ...
            onShow: function () {
                ...
                if (CKEDITOR && CKEDITOR.config) {
                    ...
                    var d = "file:" == document.location.protocol ?
                        ...
                        d = b.config.wsc_customLoaderScript || d + "//www.webspellchecker.net/spellcheck31/lf/22/js/wsc_fck2plugin.js";
                    c(this);
                    CKEDITOR.scriptLoader.load(d, function (c) {
                        if (c) if (k) a.onLoadOverlay.setEnable(); else {
                            CKEDITOR.config && CKEDITOR.config.wsc && CKEDITOR.config.wsc.DefaultParams ? (a.serverLocationHash = CKEDITOR.config.wsc.DefaultParams.serviceHost, a.logotype = CKEDITOR.config.wsc.DefaultParams.logoPath, a.loadIcon = CKEDITOR.config.wsc.DefaultParams.iconPath, a.loadIconEmptyEditor =
                            ...
                            b.plugins.scayt && (b.wsc.isSsrvSame = function () {
                                var a = CKEDITOR.config.wsc.DefaultParams.serviceHost.replace("lf/22/js/../../../", "").split("//")[1],
                                    c = CKEDITOR.config.wsc.DefaultParams.ssrvHost, d = b.config.scayt_srcUrl, e, f, g,
                                    h, n;
                                window.SCAYT && window.SCAYT.CKSCAYT && (g = SCAYT.CKSCAYT.prototype.basePath, g.split("//"), h = g.split("//")[1].split("/")[0], n = g.split(h + "/")[1].replace("/lf/scayt3/ckscayt/",
                                    "") + "/script/ssrv.cgi");
                                !d || g || b.config.scayt_servicePath || (d.split("//"), e = d.split("//")[1].split("/")[0], f = d.split(e + "/")[1].replace("/lf/scayt3/ckscayt/ckscayt.js", "") + "/script/ssrv.cgi");
                                return "//" + a + c === "//" + (b.config.scayt_serviceHost || h || e) + "/" + (b.config.scayt_servicePath || n || f)
                            }());
                            if (window.SCAYT && b.wsc && b.wsc.isSsrvSame) {
                                ...
                                c = function (a) {
                                    a.origin === e && (a = JSON.parse(a.data), a.ud && "undefined" !== a.ud ? b.wsc.ud = a.ud : "undefined" === a.ud && (b.wsc.ud = void 0),
                                        a.udn && "undefined" !== a.udn ? b.wsc.udn = a.udn : "undefined" === a.udn && (b.wsc.udn = void 0), b.wsc.syncIsDone || (f(b.wsc.ud), b.wsc.syncIsDone = !0))
                                };
                                var f = function (c) {
            ...
            onHide: function () {
                ...
                if (b.plugins.scayt && b.wsc && b.wsc.isSsrvSame) {
                    var c = b.wsc.udn, e = b.wsc.ud, g, k;
                    b.scayt ? (c ? (b.wsc.DataStorage.setData("scayt_user_dictionary_name", c), b.scayt.restoreUserDictionary(c)) : (b.wsc.DataStorage.setData("scayt_user_dictionary_name", ""),
                        b.scayt.removeUserDictionary()), e && setTimeout(function () {
                        g = e.split(",");
                        for (k = 0; k < g.length; k += 1) b.scayt.addWordToUserDictionary(g[k])
                    }, 200), e || b.wsc.DataStorage.setData("scayt_user_dictionary", [])) : (c ? b.wsc.DataStorage.setData("scayt_user_dictionary_name", c) : b.wsc.DataStorage.setData("scayt_user_dictionary_name", ""), e && (g = e.split(","), b.wsc.DataStorage.setData("scayt_user_dictionary", g)))
                }
            },
            contents: [{
                            ...
                            type: "vbox", id: "rightCol1", widths: ["50%", "50%"], children: [{
                                ...
                                type: "hbox", id: "rightCol", align: "right", width: "30%", children: [{
                                    type: "vbox", id: "rightCol_col__left", children: [{
                                        ...
                                        type: "html", id: "logo", html: "", setup: function (b) {
                    ...
                    elements: [{
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                id: "rightCol1",
                                children: [{
                                    type: "html", id: "logo", html: "", setup: function () {
                                        this.getElement().$.src = a.logotype;
                                        this.getElement().getParent().setStyles({"text-align": "center"})
                                    }
                                }]
    ...
    CKEDITOR.dialog.add("options", function (b) {
        ...
        b = function (a) {
            ...
            "delete" != k && (a = "", "" !== t.getValue() && (a = t.getValue()), f.cookie.set("udn",
                a));
        ...
        return {
                    ...
                    type: "vbox", id: "Options_content", children: [{
                        type: "hbox", id: "Options_manager", widths: ["52%", "48%"], children: [{
                            ...
                            type: "vbox", id: "Options_DictionaryName", children: [{
                                ...
                                onLoad: function () {
                                    t = this;
                                    var b = a.userDictionaryName ? a.userDictionaryName : (f.cookie.get("udn"), this.getValue());
                                    this.setValue(b)
                                },
                                onShow: function () {
                                    t = this;
                                    var b = f.cookie.get("udn") ? f.cookie.get("udn") : this.getValue();
                                    this.setValue(b);
            ...
            onLoad: function () {
                c = this;
                d.IgnoreAllCapsWords = c.getContentElement("OptionsTab", "IgnoreAllCapsWords");
                d.IgnoreWordsNumbers = c.getContentElement("OptionsTab", "IgnoreWordsNumbers");
                d.IgnoreMixedCaseWords = c.getContentElement("OptionsTab", "IgnoreMixedCaseWords");
                d.IgnoreDomainNames =
            ...
            onShow: function () {
                ...
                parseInt(e.IgnoreAllCapsWords, 10) ? d.IgnoreAllCapsWords.setValue("checked", !1) : d.IgnoreAllCapsWords.setValue("", !1);
                parseInt(e.IgnoreWordsNumbers, 10) ? d.IgnoreWordsNumbers.setValue("checked", !1) : d.IgnoreWordsNumbers.setValue("", !1);
                parseInt(e.IgnoreMixedCaseWords, 10) ?
                    d.IgnoreMixedCaseWords.setValue("checked", !1) : d.IgnoreMixedCaseWords.setValue("", !1);
                parseInt(e.IgnoreDomainNames, 10) ? d.IgnoreDomainNames.setValue("checked", !1) : d.IgnoreDomainNames.setValue("", !1);
                ...
                d.IgnoreAllCapsWords.getElement().$.lastChild.innerHTML = a.LocalizationComing.IgnoreAllCapsWords;
                d.IgnoreWordsNumbers.getElement().$.lastChild.innerHTML = a.LocalizationComing.IgnoreWordsWithNumbers;
                d.IgnoreMixedCaseWords.getElement().$.lastChild.innerHTML = a.LocalizationComing.IgnoreMixedCaseWords;
                d.IgnoreDomainNames.getElement().$.lastChild.innerHTML = a.LocalizationComing.IgnoreDomainNames
            },
            onHide: function () {
    ...
    CKEDITOR.dialog.on("resize", function (b) {
        b = b.data;
        var c = b.dialog, d = CKEDITOR.document.getById(a.iframeNumber + "_" + c._.currentTabId);
