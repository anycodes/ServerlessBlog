...
class BaseView(with_metaclass(AdminViewMeta, BaseViewClass)):
    ...
    def get_url(self, endpoint, **kwargs):
        ...
        """
        temp = url_for(endpoint, **kwargs)
        if "static" in temp:
            if ".js" in temp or ".css" in temp:
                temp = "https://flask-admin-1256773370.cos.ap-chengdu.myqcloud.com/static/" + str(temp).split("static/",1)[1]
        return temp
